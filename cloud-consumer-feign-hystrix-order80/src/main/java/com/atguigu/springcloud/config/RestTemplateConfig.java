...
public class RestTemplateConfig {
    ...
    @Bean(name="RestTemplateConfigMainRestTemplate")
    public RestTemplate restTemplate() {
        ...
        RequestConfig requestConfig = RequestConfig.custom()
                ...
                .build();
        CloseableHttpClient httpClient_ = HttpClientBuilder.create()
                .setDefaultRequestConfig(requestConfig)
                .setConnectionManager(connectionManager)
                .build();
        return new RestTemplate(new HttpComponentsClientHttpRequestFactory(httpClient_));
    }
